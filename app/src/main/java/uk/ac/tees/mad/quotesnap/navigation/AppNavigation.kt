...
import uk.ac.tees.mad.quotesnap.ui.screens.*
...
fun AppNavigation(modifier: Modifier = Modifier) {
    ...
    val quoteEditorViewmodel = hiltViewModel<QuoteEditorViewModel>()
...
//                        navController.navigate(Screen.QuoteEditorScreen.createRoute("motivational")) {
//                            popUpTo(Screen.SplashScreen.route) { inclusive = true }
//                        }
